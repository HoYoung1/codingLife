...
def price_order(product: Dict, quantity: int, shipping_method):
    ...
    shipping_per_case = shipping_method["discountedFee"] if base_price > shipping_method["discountThreshold"] else shipping_method["feePerCase"]
