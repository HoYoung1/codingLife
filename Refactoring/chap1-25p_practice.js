...
function statement(invoice, plays){
    ...
    for (let perf of invoice.performances) {
        ...
        thisAmount = dict[play.type];
        if (perf.audience > dict[play.type].baseAudience){
            thisAmount += dict[play.type].additionalAmount + dict[play.type].additionalFare 
        }
